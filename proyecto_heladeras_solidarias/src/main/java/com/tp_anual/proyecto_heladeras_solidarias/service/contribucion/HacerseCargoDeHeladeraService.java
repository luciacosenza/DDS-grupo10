...
public class HacerseCargoDeHeladeraService extends ContribucionService {
    ...
    public HacerseCargoDeHeladeraService(HacerseCargoDeHeladeraRepository vHacerseCargoDeHeladeraRepository) {
        super();
    ...
    protected void calcularPuntos() {
        ...
        for (HacerseCargoDeHeladera hacerseCargoDeHeladera : hacerseCargoDeLaHeladeras ) {
            ...
            guardarContribucion(hacerseCargoDeHeladera);    // Al guardar la contribución, se guarda el colaborador por cascada
